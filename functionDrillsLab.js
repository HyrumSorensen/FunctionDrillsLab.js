...
console.log(bestMovie('Megamind'));
...
function theEliminator(contestantArray, loser) {
  for (let i = 0; i < contestants.length; i++) {
    if (contestantArray[i] === loser) {
      contestantArray.splice(i, 1);
    }
  }
...
function upperPrint(string) {
  console.log(string.toUpperCase());
}
 upperPrint(sampleString);
...
//console.log(emailCheck("bad email"));
...
function frogShopper(goldToSpend) {
  for (let i = 0; i < 3; i++) {
    if (goldToSpend % 3 != 0) {
        goldToSpend--;
    }
